# Приложения:
-[Генератор случайного узора мозаичной плитки](https://subbiger.github.io/demo/) с выбором из нескольких текстур и некоторыми другими опциями (написан на чистом JS).
